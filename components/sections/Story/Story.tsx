        ...
        <ul className={css.storyList}>
          <li className={css.storyItem}>
            <p className={css.storyText}>
              Black Fire Cheer and Dance wurde im Jänner 2025 von Anna
              (Gründerin, Headcoach & sportliche Leitung) gemeinsam mit Bettina
              ins Leben gerufen.
            </p>
          ...
          <li className={css.storyItem}>
            <p className={css.storyText}>
              Schon wenige Wochen nach der Gründung nahmen wir im März an
              unserer ersten Meisterschaft teil - und holten auf Anhieb den
          ...
          <li className={css.storyItem}>
            <p className={css.storyText}>
              ...
              großem Erfolg absolvierten: 1. Platz in Pom und 1. Platz in
              HipHop!
            </p>
            <IoRibbon className={css.icon} />
          </li>
